        ...
        <g>
            ...
            <template v-for="(publisher,i) in publishers">
                <template v-for="(p,index) in publisher">
                    <rect fill="#fff" :key="index+'r'+i" stroke="#000" :y="i*lineheight+yOffset"
                    ...
                    <line :key="index+'l'+i" stroke="#000" stroke-width="7"
                    ...
                    <path stroke-dasharray='10, 10, 5' stroke="black" fill="#fff" stroke-width="7" :d="getPath(i)"
                        :key="index+'p'+i">
