        ...
        <g>
            ...
            <template v-for="(publisher,i) in publishers">
                <template v-for="(p,index) in publisher">
                    <rect :fill="index!=0?'#eee':'#fff'" :key="index+'r'+i" stroke="#000" :y="i*lineheight+yOffset"
            ...
            <template v-for="(subscriber,i) in subscribers">
                <template v-for="(p,index) in subscriber">
                    <rect :fill="index==0?'#eee':'#fff'" :key="index+'rs'+i" stroke="#000" :y="i*lineheight+yOffsetSub"
...
const publishers = [
    ...
    [{ label: "flv files" }, { label: "record" }],
    [{ label: "ts files" }, { label: "ts" }]
